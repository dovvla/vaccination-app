...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:s="http://tim.robot/obrazac_saglasnosti_za_imunizaciju" version="2.0">
    <xsl:template match="/">
        <html>
            <head>
            ...
            <body>
                ...
                <p class="indent-paragraph">
                    <b>Prezime</b>
                    <xsl:value-of select="concat(' ', //s:Prezime, ' | ')"/>
                    <b>Ime</b>
                    <xsl:value-of select="concat(' ', //s:Ime, ' | ')"/>
                    <b>Ime roditelja</b>
                ...
                <p class="indent-paragraph">
                    <b>Izjavljujem da: <xsl:value-of select="concat(' ', //s:Saglasnost)"/>,</b>
