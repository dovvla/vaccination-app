...
public class Korisnik implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        class MyGrantedAuthortity implements GrantedAuthority {
            private String role;

            public MyGrantedAuthortity(String role) {
                this.role = role;
            }
        ...
        return Collections.singleton(new MyGrantedAuthortity(this.rola));
    }
