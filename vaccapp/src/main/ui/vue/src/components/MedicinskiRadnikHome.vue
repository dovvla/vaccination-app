<template>
  <div>
    <b-navbar fixed="top" toggleable="lg" type="light" variant="light">
      <b-navbar-brand href="/medicinski-radnik-home">Home Page</b-navbar-brand>
              ...
              <b-card bg-variant="light" align-self="center">
                ...
                <b-row>
                  <p
                    ...
                    "
                  >
                    {{ "Ekstremitet: " + primljenaVakcina.ekstremitet }}
                  </p>
                </b-row>
                <b-row>
                  <p
                    ...
                    "
                  >
                    {{ "Serija: " + primljenaVakcina.serijaVakcine }}
                  </p>
                </b-row>
                <b-row>
                  <p
                    ...
                    "
                  >
                    {{ "Proizvodjac: " + primljenaVakcina.proizvodjac }}
                  </p>
                </b-row>
                ...
                <b-row>
                  ...
                  <p
                    ...
                    "
                  >
                    {{ primljenaVakcina.nezeljenaReakcija }}
                  </p>
                </b-row>
              </b-card>
            </div>
...
export default {
  ...
  methods: {
    pretraziSaglasnosti() {
      ...
      this.axios
        .get(`/api/saglasnost/user/${this.jmbg}`, {
          headers: {
        ...
        .then((response) => {
          ...
          //console.log(json);
          this.saglasnosti = json[1].children.map((child) => child.children[0]);
    ...
    dodajVakcinacija() {
      ...
      if (this.primljeneVakcine.length < 2) {
        this.primljeneVakcine = [
          ...this.primljeneVakcine,
          {
            naziv: this.novaNaziv,
            ekstremitet: this.novaEkstremitet,
            serijaVakcine: this.novaSerija,
            proizvodjac: this.novaProizvodjac,
            nezeljenaReakcija: this.novaNezeljena,
          },
        ];
      } else {
